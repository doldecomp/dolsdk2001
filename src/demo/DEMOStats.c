...
void DEMOPrintf(short, short, char *, ...);
unsigned long strlen(const char *);
unsigned long GXReadGP0Metric(void);
unsigned long GXReadGP1Metric(void);
void GXClearGPMetric(void);
void GXSetGPMetric(unsigned long, unsigned long);
void GXReadMemMetric(unsigned long *, unsigned long *, unsigned long *, unsigned long *, unsigned long *, unsigned long *, unsigned long *, unsigned long *, unsigned long *, unsigned long *);
void GXClearMemMetric(void);
void GXReadPixMetric(unsigned long *, unsigned long *, unsigned long *, unsigned long *, unsigned long *, unsigned long *);
void GXClearPixMetric(void);
void GXReadVCacheMetric(unsigned long *, unsigned long *, unsigned long *);
void GXSetVCacheMetric(unsigned long);
