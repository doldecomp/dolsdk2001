...
void GXSetGPMetric(GXPerf0 perf0, GXPerf1 perf1)
{
    ...
    case GX_PERF0_TRIANGLES:           reg = 0x2303AE7F; GX_WRITE_RAS_REG_alt(reg); break;
    case GX_PERF0_CLIP_RATIO:          reg = 0x153;      GX_WRITE_XF_REG(6, reg); break;
    case GX_PERF0_TRIANGLES_CULLED:    reg = 0x23038E7F; GX_WRITE_RAS_REG_alt(reg); break;
    case GX_PERF0_TRIANGLES_PASSED:    reg = 0x23039E7F; GX_WRITE_RAS_REG_alt(reg); break;
    case GX_PERF0_TRIANGLES_SCISSORED: reg = 0x23031E7F; GX_WRITE_RAS_REG_alt(reg); break;
    case GX_PERF0_TRIANGLES_0TEX:      reg = 0x2303AC3F; GX_WRITE_RAS_REG_alt(reg); break;
    case GX_PERF0_TRIANGLES_1TEX:      reg = 0x2303AC7F; GX_WRITE_RAS_REG_alt(reg); break;
    case GX_PERF0_TRIANGLES_2TEX:      reg = 0x2303ACBF; GX_WRITE_RAS_REG_alt(reg); break;
    case GX_PERF0_TRIANGLES_3TEX:      reg = 0x2303ACFF; GX_WRITE_RAS_REG_alt(reg); break;
    case GX_PERF0_TRIANGLES_4TEX:      reg = 0x2303AD3F; GX_WRITE_RAS_REG_alt(reg); break;
    case GX_PERF0_TRIANGLES_5TEX:      reg = 0x2303AD7F; GX_WRITE_RAS_REG_alt(reg); break;
    case GX_PERF0_TRIANGLES_6TEX:      reg = 0x2303ADBF; GX_WRITE_RAS_REG_alt(reg); break;
    case GX_PERF0_TRIANGLES_7TEX:      reg = 0x2303ADFF; GX_WRITE_RAS_REG_alt(reg); break;
    case GX_PERF0_TRIANGLES_8TEX:      reg = 0x2303AE3F; GX_WRITE_RAS_REG_alt(reg); break;
    case GX_PERF0_TRIANGLES_0CLR:      reg = 0x2303A27F; GX_WRITE_RAS_REG_alt(reg); break;
    case GX_PERF0_TRIANGLES_1CLR:      reg = 0x2303A67F; GX_WRITE_RAS_REG_alt(reg); break;
    case GX_PERF0_TRIANGLES_2CLR:      reg = 0x2303AA7F; GX_WRITE_RAS_REG_alt(reg); break;
    case GX_PERF0_QUAD_0CVG:           reg = 0x2402C0C6; GX_WRITE_RAS_REG_alt(reg); break;
    case GX_PERF0_QUAD_NON0CVG:        reg = 0x2402C16B; GX_WRITE_RAS_REG_alt(reg); break;
    case GX_PERF0_QUAD_1CVG:           reg = 0x2402C0E7; GX_WRITE_RAS_REG_alt(reg); break;
    case GX_PERF0_QUAD_2CVG:           reg = 0x2402C108; GX_WRITE_RAS_REG_alt(reg); break;
    case GX_PERF0_QUAD_3CVG:           reg = 0x2402C129; GX_WRITE_RAS_REG_alt(reg); break;
    case GX_PERF0_QUAD_4CVG:           reg = 0x2402C14A; GX_WRITE_RAS_REG_alt(reg); break;
    case GX_PERF0_AVG_QUAD_CNT:        reg = 0x2402C1AD; GX_WRITE_RAS_REG_alt(reg); break;
    ...
    gx->perf1 = perf1;
    switch (gx->perf1) {
    case GX_PERF1_TEXELS:      reg = 0x67000042; GX_WRITE_RAS_REG_alt(reg); break;
    case GX_PERF1_TX_IDLE:     reg = 0x67000084; GX_WRITE_RAS_REG_alt(reg); break;
    case GX_PERF1_TX_REGS:     reg = 0x67000063; GX_WRITE_RAS_REG_alt(reg); break;
    case GX_PERF1_TX_MEMSTALL: reg = 0x67000129; GX_WRITE_RAS_REG_alt(reg); break;
    case GX_PERF1_TC_CHECK1_2: reg = 0x6700014B; GX_WRITE_RAS_REG_alt(reg); break;
    case GX_PERF1_TC_CHECK3_4: reg = 0x6700018D; GX_WRITE_RAS_REG_alt(reg); break;
    case GX_PERF1_TC_CHECK5_6: reg = 0x670001CF; GX_WRITE_RAS_REG_alt(reg); break;
    case GX_PERF1_TC_CHECK7_8: reg = 0x67000211; GX_WRITE_RAS_REG_alt(reg); break;
    case GX_PERF1_TC_MISS:     reg = 0x67000252; GX_WRITE_RAS_REG_alt(reg); break;
    ...
    case GX_PERF1_CLOCKS: reg = 0x67000021; GX_WRITE_RAS_REG_alt(reg); break;
