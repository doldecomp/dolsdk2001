...
Mtx *MTXPushFwd(MTXStack *sPtr, Mtx *m) {
    ...
    if (sPtr->stackPtr == NULL) {
        ...
        MTXConcat(sPtr->stackPtr, m, sPtr->stackPtr + 1);
        sPtr->stackPtr++;
    }
    return sPtr->stackPtr;
}
...
Mtx *MTXPushInv(MTXStack *sPtr, Mtx *m) {
    ...
    if (sPtr->stackPtr == NULL) {
        ...
        MTXConcat(&mInv, sPtr->stackPtr, sPtr->stackPtr + 1);
        sPtr->stackPtr++;
    }
    return sPtr->stackPtr;
}
...
Mtx *MTXPushInvXpose(MTXStack *sPtr, Mtx *m) {
    ...
    if (sPtr->stackPtr == NULL) {
        ...
        MTXConcat(sPtr->stackPtr, &mIT, sPtr->stackPtr + 1);
        sPtr->stackPtr++;
    }
    return sPtr->stackPtr;
}
