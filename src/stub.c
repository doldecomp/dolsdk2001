...
TEXT_STUB(AIRegisterStreamCallback)
TEXT_STUB(AIResetStreamSampleCount)
TEXT_STUB(AISetStreamPlayState)
TEXT_STUB(AISetStreamTrigger)
TEXT_STUB(AISetStreamVolLeft)
TEXT_STUB(AISetStreamVolRight)
